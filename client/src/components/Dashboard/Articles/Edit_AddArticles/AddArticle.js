...
const AddArticle = () => {
  ...
  const handleEditorState = wysiwygState => {
    formik.setFieldValue('content', wysiwygState, true);
  };
  ...
  return (
    <>
      ...
      <form className="mt-3 article_form" onSubmit={formik.handleSubmit}>
        ...
        { articles.loading ? <Loader/> : <Button variant="contained" color="primary" type="submit">
          Add article
        </Button>}
      </form>
    </>
